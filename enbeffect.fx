...
uniform float StreetlightIntensity < string UIName = "Streetlight Intensity"; string UICategory = "Lighting"; float UIMin = 0.0; float UIMax = 10.0; > = 1.0;
uniform float Corona < string UIName = "Corona"; string UICategory = "Lighting"; float UIMin = 0.0; float UIMax = 10.0; > = 1.0;
uniform float ParticlesSmoke < string UIName = "Particles Smoke"; string UICategory = "Effects"; float UIMin = 0.0; float UIMax = 10.0; > = 1.0;
uniform float BackfireReflection < string UIName = "Backfire Reflection"; string UICategory = "Effects"; float UIMin = 0.0; float UIMax = 10.0; > = 1.0;
uniform float CarEffectsBrightness < string UIName = "Car Effects Brightness"; string UICategory = "Vehicle"; float UIMin = 0.0; float UIMax = 10.0; > = 1.0;
uniform float EmergencyLights < string UIName = "Emergency Lights"; string UICategory = "Vehicle"; float UIMin = 0.0; float UIMax = 10.0; > = 1.0;
